use crate::{
    asset_server::TRANSPARENT_CHAR, bitmap::Bitmap, drawable_object::{Drawable, DrawableObject}, utils::XY
};
...
impl FrameAssembler {
    ...
    pub fn insert (&mut self, bitmap_container: &DrawableObject, position: &XY<i32>) {
